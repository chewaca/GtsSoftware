			  ...
			  <div class="row-fluid sortable" >
			    ...
			    <div class="box-inner">	
			      <div class="box-header well" data-original-title>
			        <h2><i class="glyphicon glyphicon-user"></i> AGREGAR PERSONAL</h2>
					</div>
						...
						<form class="form-horizontal" id="frmProceso" name="frmProceso" method="POST" action="<%= response.encodeURL("SMVPersonal")%>">
						  ...
						  <fieldset>                                                                              
							 ...
							 <div class="form-group col-md-4" >  
                                  	...
                                  	<input type="text" style=" width: 273px"  class="form-control" id="txtNombre" name="txtNombre" data-provide="typeahead" >
                                ...
                                <div class="form-group col-md-4" >
                                  	...
                                  	<input type="text" style=" width: 273px" class="form-control" id="txtApPaterno" name="txtApPaterno" data-provide="typeahead" >     
                                  ...
                                  <div class="form-group col-md-4">   
                                  	...
                                  	<input type="text" style=" width: 273px" class="form-control" id="txtApMaterno" name="txtApMaterno" data-provide="typeahead" >                                 
                                  </div>
                             	...
                             	<div class="form-group col-md-4">                          
                                    <label class="control-label" for="typeahead1">DNI: </label>                          
                                  	<input type="text" style=" width: 250px"  class="form-control" id="txtDNI" name="txtDNI"  data-provide="typeahead" maxlength="8" onkeypress="return isNumberKey(event)" >                                  
                            	</div>
                            
                            	<div class="form-group col-md-4">  
		            				<label class="control-label" for="typeahead4">Fecha Nacimiento: </label>				            	
				             		 <input type="text"  style=" width: 250px" class="input-small datepicker" id="fcNacimiento" name="fcNacimiento" maxlength="10">		           		
			            	    </div>
			            	   
                            	<div class="form-group col-md-4">   
								<label class="control-label" for="selectError">Sexo:</label>
								<div class="controls">
								  <select id="cmbSexo" name="cmbSexo" data-rel="chosen" style="resize:none; height: 120px; width: 273px">	  
								...
								<div class="controls">
                             	...
                             	<div class="form-group col-md-4">                   
                                  <label class="control-label" for="typeahead1">Correo: </label>                              
                                  	<input type="text" style=" width: 250px"  class="form-control" id="txtCorreo" name="txtCorreo" data-provide="typeahead" >
                                 </div>
                             	...
                             	<div class="form-group col-md-4">    
                                  <label class="control-label" for="typeahead1">Teléfono 1: </label>
                                  	<input type="text" style=" width: 250px"  class="form-control" id="txtTelefono1" name="txtTelefono1"  data-provide="typeahead" maxlength="12" onkeypress="return isNumberKey(event)" >
                                  </div>
                                   </div>
                             	...
                             	<div class="form-group col-md-4">            
                                  <label class="control-label" for="typeahead1">Teléfono 2: </label>                                 
                                  	<input type="text" style=" width: 250px"  class="form-control" id="txtTelefono2" name="txtTelefono2"  data-provide="typeahead" maxlength="12" onkeypress="return isNumberKey(event)" >
                                 </div>
                             	...
                             	<div class="form-group col-md-5">  
                                      ...
                                      <textarea id="txtDescripcion" name="txtDireccion" rows="2" cols="1000" style="resize:none; height: 40px; width: 500px"></textarea>
                                  </div>
                                  </div>
