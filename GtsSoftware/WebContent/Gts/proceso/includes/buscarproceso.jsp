			...
			<div class="row-fluid sortable">
				...
				<div class="box-inner">
					<div class="box-header well" data-original-title="">
						<h2><i class="glyphicon glyphicon-search"></i> BUSCAR PROCESO</h2>
                        <div  align="right">
                           <a class="btn btn-primary btn-round btn-sm" href="/GtsSoftware/Gts/proceso/agregarproceso.jsp"> <i class="glyphicon glyphicon-plus white"></i> Nuevo </a> 
				  ...
				  <%} %>
						<form class="form-inline" name="frmCriteriosBusqueda" id="frmCriteriosBusqueda"  method="POST" action="<%= response.encodeURL("SMVProceso")%>">
