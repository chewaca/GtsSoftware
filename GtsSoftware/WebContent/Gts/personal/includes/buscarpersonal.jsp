						   ...
						   <span style="display:inline-block"> 
						    <div class="control-group">
						     ...
						     <div class="control-group">
								...
								<div class="controls">
								  <select id="cmbxArea" name="cmbxArea" style="widht:157px;" data-rel="chosen" >	
						    ...
						    <div class="control-group">
								<label class="control-label" for="selectError1">Estado:</label>
								<div class="controls">
								  <select id="cmbEstado" class="form-control" name="cmbEstado" data-rel="chosen" >	  
