			  ...
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2><i class=" icon-th-large"></i> MODIFICAR USUARIO</h2>
					</div>
						...
						<form class="form-horizontal" id="frmUsuario" name="frmUsuario" method="POST" action="<%= response.encodeURL("SMVUsuario")%>">
						  ...
						  <fieldset>                                                                              
							  <div class="control-group">                        
                                  ...
                                  <div class="controls">
                                  	<input type="text"  class="span1 typeahead" readonly="readonly" id="txtCodigo" name="txtCodigo" data-provide="typeahead" required
                         	 ...
                         	 <div class="control-group">
								...
								<div class="controls">
								  ...
								  <%for(int i=0;i<cmbRol.size();i++){
		                             %>  
									<option <%if(((ResultadoRol)cmbRol.get(i)).getCodigo()== resultado.getCodrol()) {%> selected <%}%> value= <%=((ResultadoRol)cmbRol.get(i)).getCodigo()%> >
										<%=
