			...
			<div class="row-fluid sortable">
				...
				<div class="box-inner">
					<div class="box-header well" data-original-title>
						<h2><i class="glyphicon glyphicon-search"></i> BUSCAR ACTIVO</h2>
                        <div  align="right">
                       <a class="btn btn-primary btn-round btn-sm" onclick='window.open("/GtsSoftware/Gts/activo/includes/uploadDocument.jsp","name","height=570,width=530");'> <i class="glyphicon glyphicon-file white"></i> Subir documento</a> 
                            <!-- <input id="fileToLoad" name="fileToLoad" type="file" class="form_1"/> -->
                               <a class="btn btn-primary btn-round btn-sm" href="/GtsSoftware/Gts/activo/agregaractivo.jsp"> <i class="glyphicon glyphicon-plus white"></i>Nuevo</a> 
						...
						<form class="form-horizontal2" name="frmCriteriosBusqueda" id="frmCriteriosBusqueda"  method="POST" action="<%= response.encodeURL("SMVActivo")%>">
						  ...
						  <fieldset>
						   ...
						   <% if (criterio.getNombre()!=null){
						    ...
						    <i class="glyphicon glyphicon-search icon-white"></i>Limpiar</button>			    
							</div>
						  </fieldset>
					  </form>   
				  </div>
