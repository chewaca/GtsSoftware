...
<jsp:useBean id="personalData"  scope="session" class="GtsSoftware.personal.PersonalData"></jsp:useBean>	
					...
					<div class="box-content">
						...
						<form class="form-horizontal" id="frmUsuario" name="frmUsuario" method="POST" action="<%= response.encodeURL("SMVUsuario")%>">
						  ...
						  <fieldset>                                                                              
							  ...
							  <div class="control-group">                        
                                  <label class="control-label" for="typeahead1" >ID Personal: </label>
                                  <div class="controls">
                                  	<input type="text"  class="span3 typeahead" readonly id="txtCodigo"
                                  	value="<%=personalData.getCodigo() %>"
                                  	 name="txtCodigoPersonal" data-provide="typeahead" required>
                                  </div>
                              </div>                    
                                  <label class="control-label" for="typeahead1">Nombre Personal: </label>
                                  <div class="controls">
                                  	<input type="text"  class="span3 typeahead" readonly id="txtPersonal" 
                                  	value="<%=personalData.getNombre() %>"
                                  	name="txtPersonal" data-provide="typeahead" required>
                                  </div>
                              </div>						  
							  <div class="control-group">                        
