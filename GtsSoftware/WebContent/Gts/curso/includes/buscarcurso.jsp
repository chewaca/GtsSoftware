			...
			<div class="row-fluid sortable">
				...
				<div class="box-inner">
					<div class="box-header well" data-original-title>
						<h2><i class="glyphicon glyphicon-search"></i>  BUSCAR CURSO			  </h2>						
						<div  align="right">
                               <a class="btn btn-primary btn-round btn-sm" href="/GtsSoftware/Gts/curso/agregarcurso.jsp"> <i class="glyphicon glyphicon-plus white"></i> CREAR CURSO </a> 
